...
func init() {
	...
	ClusterImageCacheDoc.Fields[1].Note = "Note: The specified `path` is relative to `/var`.\n"
	...
	ClusterImageCacheDoc.Fields[1].AddExample("", "/var/cache-archive/system")

	ClusterImageCacheDoc.Fields[1].AddExample("", "/var/cache-archive/k8s")
